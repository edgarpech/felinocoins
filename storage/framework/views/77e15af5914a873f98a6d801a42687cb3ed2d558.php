...
} elseif ($_instance->childHasBeenRendered('KSh3fne')) {
    $componentId = $_instance->getRenderedChildComponentId('KSh3fne');
    $componentTag = $_instance->getRenderedChildComponentTagName('KSh3fne');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KSh3fne');
} else {
    $response = \Livewire\Livewire::mount('crud-accounts');
    $html = $response->html();
    $_instance->logRenderedChild('KSh3fne', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php else: ?>
...
</html><?php /**PATH D:\www\Tecmonedasv3.0\resources\views/swaps.blade.php ENDPATH**/ ?>