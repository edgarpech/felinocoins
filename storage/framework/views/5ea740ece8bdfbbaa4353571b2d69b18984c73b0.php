...
} elseif ($_instance->childHasBeenRendered('O0baQ4Z')) {
    $componentId = $_instance->getRenderedChildComponentId('O0baQ4Z');
    $componentTag = $_instance->getRenderedChildComponentTagName('O0baQ4Z');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('O0baQ4Z');
} else {
    $response = \Livewire\Livewire::mount('crud-accounts');
    $html = $response->html();
    $_instance->logRenderedChild('O0baQ4Z', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php else: ?>
...
</html><?php /**PATH D:\www\TecMonedas\resources\views/my-tickets.blade.php ENDPATH**/ ?>