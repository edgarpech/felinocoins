            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    <div>
                        <div style="padding: 7px 16px; margin: 15px 8px; line-height: 25px; text-align: center;">
                            <img src="/uploads/photos/<?php echo e($user -> photo); ?>" alt="avatar.<?php echo e($user->name); ?>" width="30%" style="margin: auto; margin-bottom: 15px; border: 1px solid #fff; border-radius: 50%;">
                            <form action="<?php echo e(route('perfil', $user -> id)); ?>" method="post">
                                <label for="">Nombre</label>
                                <input readonly="true" style="color: #000; width: 300px;" type="text" name="name" value="<?php echo e($user -> name); ?>"><br><br>
                                <label for="">Nacimiento</label>
                                <input readonly="true" style="color: #000; width: 300px;" type="text" name="date_of_birth" value="<?php echo e($user -> date_of_birth); ?>"><br><br>
                                <label for="">Carrera</label>
                                <input readonly="true" style="color: #000; width: 300px;" type="text" name="career" value="<?php echo e($user -> career); ?>"><br><br>
                                <label for="">Correo</label>
                                <input readonly="true" style="color: #000; width: 300px;" type="text" name="email" value="<?php echo e($user -> email); ?>"><br><br>
...
</html><?php /**PATH /home/tecmon/tecmonedas/resources/views/user/perfil.blade.php ENDPATH**/ ?>