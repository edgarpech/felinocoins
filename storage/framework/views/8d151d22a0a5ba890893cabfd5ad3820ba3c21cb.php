...
} elseif ($_instance->childHasBeenRendered('zNCsA0v')) {
    $componentId = $_instance->getRenderedChildComponentId('zNCsA0v');
    $componentTag = $_instance->getRenderedChildComponentTagName('zNCsA0v');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zNCsA0v');
} else {
    $response = \Livewire\Livewire::mount('crud-accounts');
    $html = $response->html();
    $_instance->logRenderedChild('zNCsA0v', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php else: ?>
...
</html><?php /**PATH D:\www\Tecmonedasv3.0\resources\views/my-tickets.blade.php ENDPATH**/ ?>