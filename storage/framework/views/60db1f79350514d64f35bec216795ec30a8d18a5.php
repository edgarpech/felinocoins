...
} elseif ($_instance->childHasBeenRendered('BHIHKRA')) {
    $componentId = $_instance->getRenderedChildComponentId('BHIHKRA');
    $componentTag = $_instance->getRenderedChildComponentTagName('BHIHKRA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BHIHKRA');
} else {
    $response = \Livewire\Livewire::mount('crud-accounts');
    $html = $response->html();
    $_instance->logRenderedChild('BHIHKRA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php else: ?>
        ...
        <div class="relative flex items-top justify-center min-h-screen sm:items-baseline py-4 sm:pt-4"
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <?php $__currentLoopData = $swaps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $act): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div style="box-shadow: 0 4px 8px 0 rgba(212,175,55,0.5); transition: 0.3s;">
                        <div style="padding: 25px 16px; margin: 15px 8px; line-height: 25px; text-align: center;">
                            <h4>Tipo de canje: <b><?php echo e(ucfirst($act->name)); ?>.</b></h4>
                            <p>Precio: $<?php echo e($act->cost); ?> TM</p>
                            <p>Descripción: <?php echo e(ucfirst($act->description)); ?>.</p>
                            <form action="<?php echo e(route('admin.store')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <input class="hidden" style="color: #000;" type="text" name="id" placeholder="Usuario" autocomplete="off" value="<?php echo e(Auth::user()->id); ?>">
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.nav-link','data' => ['class' => 'text-white','style' => 'border-color: rgb(234, 179, 8);','href' => route('admin.view_tickets'),'active' => request()->routeIs('admin.view_tickets')]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-white','style' => 'border-color: rgb(234, 179, 8);','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.view_tickets')),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('admin.view_tickets'))]); ?>
...
</html><?php /**PATH /home/tecmon/tecmonedas/resources/views/swaps.blade.php ENDPATH**/ ?>