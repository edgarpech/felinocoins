 <?php $__env->slot('header', null, []); ?> 
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('css/responsive_table_tickets.css')); ?>">
    </head>
...
<div class="py-12">
    <div class="text-center max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="search overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            <?php if($updateMode): ?>
                <?php echo $__env->make('livewire.tickets/update', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php else: ?>
                <?php echo $__env->make('livewire.tickets/create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
        </div>
        <table style="margin: 15px auto;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><?php echo e($ticket->type_id); ?></td>
...
</div><?php /**PATH D:\www\TecMonedas\resources\views/livewire/tickets/crud-tickets.blade.php ENDPATH**/ ?>